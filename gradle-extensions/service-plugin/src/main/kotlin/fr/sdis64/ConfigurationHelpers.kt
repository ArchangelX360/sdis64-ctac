...
// private fun ProviderFactory.propOrEnvProvider(propName: String, envVar: String? = null): Provider<Result<String>> {
//    val err =
//        Result.failure<String>(IllegalStateException("either property '$propName' or environment variable $envVar must be defined"))
//    return gradleProperty(propName)
//        .orElse(environmentVariable(envVar ?: ""))
//        .map { s ->
//            when {
//                s.isNotBlank() -> Result.success(s)
//                else -> err
//            }
//        }.orElse(err)
// }
